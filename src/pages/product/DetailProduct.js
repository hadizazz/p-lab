      ...
      <Row xs={1} lg={2} md={1} sm={1} xl={2} className="my-5">
        <Col style={{ width: "42%", height: "auto" }} className="mx-3">
          ...
          {products.map((product, index) => (
            ...
            <div className="coverZoom" key={index}>
                <ImageZoom id="featured"  src={thisProduct.image} zoom="150" />
           </div>
            ))}
          </>
          <Row className="mt-3">
              ...
              {products.map((product, index) => (
                <div key={index}>
                  <img
                    ...
                    alt="img"
                    onClick={() => changeImage(thisProduct.img1)}
                  />
                </div>
              ))}
            </Col>
              ...
              {products.map((product, index) => (
                <div key={index}>
                  <img
                    ...
                    alt="img"
                    onClick={() => changeImage(thisProduct.img2)}
                  />
                </div>
              ))}
            </Col>
              ...
              {products.map((product, index) => (
                <div key={index}>
                  <img
                    ...
                    alt="img"
                    onClick={() => changeImage(thisProduct.img3)}
                  />
                </div>
              ))}
            </Col>
        ...
        <Col className="my-5">
          <div className="detailproduct">
            <h3 className="titleDetail text-start pb-3">{id}</h3>
          ...
          <div className="text-start my-4">
            <Button
              ...
              size="md"
              onClick={() => addItem(thisProduct, parseInt(val, 10))}
            >
              {" "}
              Add To Cart{" "}
            </Button>
                ...
                <Col id="review_form_wrapper" className="text-start formReview">
                  ...
                  <div id="formReview">
                    <Form>
                      ...
                      >
                        <Form.Label>
                          Your review<span style={{ color: "#585b53" }}>*</span>{" "}
                        </Form.Label>
